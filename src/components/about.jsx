function About() {
    return (
        <div className='about'>
          <p>
            Hi! My name is Alex, I'm currently a Senior Product Designer at <a href="https://shopify.com">Shopify</a>, where I focus on mobile design for entrepreneurs looking to start and grow their businesses.
          </p>
          <p>
            I have over 10 years of experience working as a designer and developer, and I've spent the last 7 of those focused primarily on mobile apps.
          </p>
          <p>
