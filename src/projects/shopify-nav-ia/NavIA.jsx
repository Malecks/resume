  ...
  return (
    <article className='project'>
      ...
      <section>
        <h3>TLDR;</h3>
        <p>
          This project sought to re-define the navigation and IA across the whole of the Shopify mobile app. With considered updates, we hoped to remove unintuitive behaviours, introduce functionality for multi-tasking, ease account and store switching, and create a polished and extensible foundation for future feature work.
        </p>
      </section>
      ...
      <section>
        ...
        <ul>
          ...
          <li>Work cross-functionally with the engineering and product managers as a trifecta member. Presenting and generating alignment with key stakeholders and senior leadership.</li>
